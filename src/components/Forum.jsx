...
export default function Forum() {
  ...
  if (!user) {
    return (
      <div className="max-w-2xl mx-auto p-4 text-center">
        <p className="text-lg text-muted-foreground">Please log in to view and create posts.</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 space-y-6">
      <ForumNavbar selectedCategory={selectedCategory} setSelectedCategory={setSelectedCategory} />
